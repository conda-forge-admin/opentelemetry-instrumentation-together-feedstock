...
pixi add opentelemetry-instrumentation-together
# for installing globally
pixi global install opentelemetry-instrumentation-together
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-together` available on your platform:
...
```
pixi search opentelemetry-instrumentation-together --channel conda-forge
```
